...
def processFile(update,bot,message,file,obten_name,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.sendMessage(-1001736324444,finishInfo+'\n'+filesInfo,parse_mode='html')
        if len(files)>0:
...
def sendTxt(name,files,update,bot):
                ...
                bot.sendFile(-1001736324444,name)
                os.unlink(name)
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        tl_admin_user = os.environ.get('Penelopeplp')
...
def main():
    ...
    bot_token = '5507923944:AAH63kWnqZr9Kh6zn5pc-MPsePkzpMQxgC0'
